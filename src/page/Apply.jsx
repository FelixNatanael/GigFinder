...
function Apply() {
  return (
    <div className="overflow-hidden">
      ...
      <div className="border w-auto border-black mx-24 mb-10 h-screen pl-10 py-6 flex flex-col overflow-hidden">
        ...
        <label class="block">
          ...
          <input
            type="file"
            class="block w-full text-lg rounded-lg text-[#cdcdcd] mt-2 border w-[600px]
    ...
    "
        ...
        <input
          type="email"
          className="mt-2 border w-[600px] outline-none rounded px-4 h-9"
          required
        />
        <div className="text-white ml-auto m-10   font-bold mt-auto">
        <Popup trigger={<button className="border w-40 bg-blue-500 rounded-lg h-12">Apply</button>} modal nested>
      {close => (
          ...
          <div className="modal-container bg-white w-[500px] md:max-w-md mx-auto rounded shadow-lg z-50 overflow-y-auto">
            <div className="modal-content py-4 text-left px-6">
              <div className="flex flex-col items-center pb-3">
                ...
                <button className="modal-close cursor-pointer z-50 relative left-40 bottom-10" onClick={close}>
                ...
                <p className="text-base font-bold px-5 mt-5">Your Application has been succesfully sent</p>
                <p className="text-base font-medium mt-">We will inform you of the results via your email</p>
                <Link to='/lowongan'>
                <button className="w-20 h-10 bg-blue-500 text-white font-semibold text-lg rounded-md mt-5">Back</button>
                </Link>
              </div>
            </div>
          </div>
